  ...
  if (proyectos.length > 1 && !selectedProyecto) {
    return (
      <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
        <div>
          <h2 className="text-xl font-black text-stone-900 tracking-tight">Tus Proyectos</h2>
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      {proyectos.length > 1 && (
        ...
        >
          <span className="transition-transform group-hover:-translate-x-1">←</span> Volver a mis proyectos
        </button>
      )}
